...
const ResponseCreateBooking_1 = require("./dtos/ResponseCreateBooking");
const ResponseUpdateBooking_1 = require("./dtos/ResponseUpdateBooking");
let AppController = class AppController {
    ...
    async createBookingWithService(postData) {
...
__decorate([
    (0, common_1.Post)('/booking-service'),
    __param(0, (0, common_2.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [BookDTO_1.BookDTO]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "createBookingWithService", null);
__decorate([
